...
// $Id$
//
/// \file cosmicEventAction.hh
/// \brief Definition of the cosmicEventAction class
...
class cosmicEventAction : public G4UserEventAction
{
  public:
    ...
    static cosmicEventAction* Instance();
  ...
  private:
    static cosmicEventAction* fgInstance;  
