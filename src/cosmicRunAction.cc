...
void cosmicRunAction::BeginOfRunAction(const G4Run* aRun)
{ 
  ...
  cosmicEventAction::Instance()->Reset();
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void cosmicRunAction::EndOfRunAction(const G4Run* aRun)
{
  ...
  // Compute dose
  //
  G4double energySum  = cosmicEventAction::Instance()->GetEnergySum();
  G4double energy2Sum = cosmicEventAction::Instance()->GetEnergy2Sum();
  G4double rms = energy2Sum - energySum*energySum/nofEvents;
  if (rms > 0.) rms = std::sqrt(rms); else rms = 0.;

  G4double mass = cosmicSteppingAction::Instance()->GetVolume()->GetMass();
  ...
  const G4ParticleGun* particleGun 
    = cosmicPrimaryGeneratorAction::Instance()->GetParticleGun();
  ...
  G4cout
     ...
     << cosmicSteppingAction::Instance()->GetVolume()->GetName() << " : " 
